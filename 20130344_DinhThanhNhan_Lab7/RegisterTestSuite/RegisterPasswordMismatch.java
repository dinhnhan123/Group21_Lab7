...
public class RegisterPasswordMismatch {
  ...
  public void testRegisterPasswordMismatch() throws Exception {
    ...
    driver.findElement(By.xpath("//form[@id='form_register']/input")).sendKeys("user03");
    ...
    driver.findElement(By.xpath("//form[@id='form_register']/div/input")).sendKeys("Dinhnhan12345");
    driver.findElement(By.id("PasswordConfirm")).click();
    driver.findElement(By.id("PasswordConfirm")).clear();
    driver.findElement(By.id("PasswordConfirm")).sendKeys("Dinhnhan654321");
