...
public class RegisterShortPassword {
  ...
  public void testRegisterShortPassword() throws Exception {
    ...
    driver.findElement(By.xpath("//form[@id='form_register']/input")).sendKeys("user999");
    driver.findElement(By.id("Phone")).click();
    driver.findElement(By.id("Phone")).clear();
    driver.findElement(By.id("Phone")).sendKeys("0867764890");
    ...
    driver.findElement(By.xpath("//form[@id='form_register']/div/input")).sendKeys("123");
