...
public class RegisterInvalidPhoneNumber {
  ...
  @Test
  public void testRegisterInvalidPhoneNumber() throws Exception {
    ...
    driver.findElement(By.xpath("//form[@id='form_register']/input")).sendKeys("dinhthanhnhan1234");
    driver.findElement(By.id("Phone")).click();
    driver.findElement(By.id("Phone")).clear();
    driver.findElement(By.id("Phone")).sendKeys("0987654321235");
    ...
    driver.findElement(By.xpath("//div[@id='main']/div/div/div[2]")).click();
