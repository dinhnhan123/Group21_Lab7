...
public class CART3 {
  ...
  public void testCART3() throws Exception {
    ...
    driver.findElement(By.xpath("//span[@id='site-cart-handle']/a/span")).click();
    driver.findElement(By.linkText("Xem giỏ hàng")).click();
    driver.findElement(By.xpath("//button[@onclick='removeItem(57929)']")).click();
    driver.findElement(By.xpath("//div[@id='cart-list']/div")).click();
    driver.findElement(By.xpath("//div[@id='cart-list']/span")).click();
  }
