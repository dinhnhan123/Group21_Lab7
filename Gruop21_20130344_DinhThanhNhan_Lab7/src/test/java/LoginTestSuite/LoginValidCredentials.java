...
public class LoginValidCredentials {
  ...
  public void testLoginValidCredentials() throws Exception {
    ...
    driver.findElement(By.id("Password")).sendKeys("Dinhthanhnhan12345");
    driver.findElement(By.id("form_login")).submit();
    driver.findElement(By.xpath("//span[@id='account-handle']/a/img")).click();
    // Ẩn nút hotline che element
    try {
      js.executeScript("document.querySelector('.hotline-phone-ring').style.display='none';");
