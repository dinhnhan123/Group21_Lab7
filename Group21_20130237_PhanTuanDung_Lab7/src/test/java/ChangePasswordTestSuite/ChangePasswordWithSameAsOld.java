package ChangePasswordTestSuite;
...
public class ChangePasswordWithSameAsOld {
  ...
  @Test
  public void testChangePasswordWithSameAsOld() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='main']/section[2]/div/div/div[2]/div/form/div/div[2]")).click();
